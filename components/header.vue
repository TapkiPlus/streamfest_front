  ...
  >
    <div class="container">
      <div class="header-wrapper">
        ...
        >
          <img class="logo_w" src="/logo.svg" alt="СТРИМФЕСТ" loading="lazy" />
          <img
            class="logo_b"
            src="/logo-blue.svg"
            alt="СТРИМФЕСТ"
...
export default {
  ...
  mounted() {
    ...
    this.checkRoutePath();
    if (this.$route.path !== "/success-page")
