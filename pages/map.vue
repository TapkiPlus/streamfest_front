  ...
  <section class="activities">
    ...
    <div class="container-wide">
      <div class="activities-tabs__content">
        <p v-if="activeStage === 1" class="tab-description">
          У нас два входа: со стороны станции МЦД-1 «Сколково» и с главной
          лестницы Технопарка. Первый этаж — развлекательный. Второй — обзорный.
          На третьем — лекторий. Залетай!
        </p>
        <p v-else class="tab-description">
          <b>Как попасть в Лекторий</b><br>
Лекторий находится на 3-м этаже со стороны красного шара с цифрой «2».<br>
Поднимайся на лифте, по лестнице или эскалатору. Тут два зала, «Каппа» и «Бобер». Они находятся в 20 метрах друг от друга.
        </p>
              ...
              <div class="map-tooltip">
                <ul class="map-tooltip__list">
                  <li class="map-tooltip__item">
                    <img
                      class="map-tooltip__icon"
                      src="/activity/info-food.svg"
                      alt=""
                    />
          ...
          <div class="map-stage--wrapper">
            <div class="map-stage" v-show="activeStage === 1">
              <div class="map-image">
                ...
                <div id="enter2"></div>
                <div id="stage1"></div>
                <img src="/activity/map-1flor.png" alt="" />
              </div>
              <div
                class="map__list--wrapper"
                :class="{ _active: openStageList }"
              >
                ...
                <button
                  class="close-list"
                  @click="openStageList = !openStageList"
                >
                  Свернуть
                </button>
              </div>
            ...
            <div class="map-stage" v-show="activeStage === 2">
              <div class="map-image">
                <div id="stage3"></div>
                <img src="/activity/map-2flor.png" alt="" />
              </div>
            </div>
            <button
            v-if="activeStage === 1"
              class="btn btn-stage btn--blue"
              @click="openStageList = !openStageList"
            >
              Что где на карте
            </button>
