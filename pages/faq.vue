      ...
      <div class="faq-items">
        ...
        >
          <p>
            ...
            <a href="https://sk.ru/technopark/"
              >Технопарке «Сколково» 17 и 18 апреля с 11:00 до 19:00.</a
            >
          </p>
        ...
        >
          <p>
            ...
            <a href="https://streamfest.ru/apply">Стать участником</a>, и
        ...
        >
          ...
          <p>
            ...
            или на <a href="mailto:info@streamfest.ru">info@streamfest.ru</a>.
          </p>
        </div>
        <button
        ...
        >
          ...
          <p>
            ...
            открытия/закрытия. В залах лектория — своя программа: полезные
        ...
        >
          <p>
            ...
            фестиваль или 17, или 18 апреля — на ваш выбор.
          </p>
          ...
          <p>
            Билеты можно купить
            <a href="https://streamfest.ru/tickets/">здесь</a> или через
            страницу
        ...
        >
          ...
          <p>
            ...
            этот участник получает ваши имя (но не фамилию) и email — так
            участник сможет узнать, кто именно купил от него билет(ы), и
        ...
        >
          ...
          <p>
            ...
            сопровождении своих родственников или опекунов в соответствии с ФЗ
            №124 (ст. 14).
          </p>
        </div>
        <button
        ...
        >
          <p>
            ...
            любые предметы, которыми можно нанести урон жизни и здоровью. Вот
            <a
        ...
        >
          <p>
            ...
            несколько кофеен, ресторан, продуктовый магазин. Вот
