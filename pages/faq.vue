    ...
    <div class="container">
      ...
      <div class="faq-items">
        ...
        >
          ...
          Где и когда пройдет Стримфест&nbsp;2022?
          <svg
            class="faq-plus"
            width="30"
            height="30"
        ...
        >
          ...
          Я развиваюсь как стример, но канал пока небольшой. Можно мне билет на
          Стримфест?
          <svg
            class="faq-plus"
            width="30"
        ...
        >
          ...
          <p>
            В залах лектория — своя программа: полезные мастер-классы для
            начинающих и продвинутых стримеров/ подкастеров, встречи с
            руководителями стрим-платформ и не только.
          </p>
          <p>
            Мы подробнее расскажем о всех деталях программы ближе к Стримфесту.
            В мае на сайте появится подробное расписание лектория, а пока
            <a
        ...
        >
          <p>
            У нас два типа билетов: билет на один день за 1300&nbsp;рублей и
            билет на оба дня за 2100&nbsp;рублей. Билет на один день позволяет
            посетить фестиваль или 25, или 26&nbsp;июня — на ваш выбор.
          </p>
          ...
          <p>
            Билеты можно <a class="link" href="/#tickets">купить здесь</a> или
            через страницу любимого
            ...
            из дней — если хотите точно повстречаться со всеми, приходите и 25, и
            26&nbsp;июня.
          </p>
          ...
          <p>
            ...
            выходить с&nbsp;фестиваля. Браслет нельзя передавать другому
            человеку. Если вы потеряете браслет, то восстановить его будет
            нельзя.
          </p>
        </div>
        <button
        ...
        >
          <p>
            ...
            целом билет от участника ничем не отличается от билета, купленного
            с&nbsp;кнопки <a href="/#tickets" class="link">«Купить билет».</a>
          </p>
        ...
        >
          ...
          <p>
            ...
            сопровождении своих родственников или опекунов в соответствии с
            ФЗ&nbsp;№124 (ст. 14).
          </p>
        </div>
        <button
        ...
        >
          ...
          Я собираюсь на Стримфест с маленьким ребенком, должен ли я платить за
          него?
          <svg
            class="faq-plus"
            width="30"
