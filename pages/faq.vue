    ...
    <div class="container">
      ...
      <div class="faq-items">
        <button
          ...
          :class="{ 'faq-item-active': accordionIds.includes(0) }"
          class="faq-item"
        >
        ...
        <div
          :class="{ visible: accordionIds.includes(0) }"
        ...
        >
          <p>
            QR-коды никто не отменял. Их просто сделали необязательными для кафе и ресторанов, а некоторые СМИ подали эту новость как полную отмену. На самом деле, это не так. Согласно <a
              href="https://www.mos.ru/authority/documents/doc/46784220/"
              class="link"
              target="_blank"
              rel="noopener noreferrer"
              >п. 33.4 указа Мэра Москвы</a
            > № 42-УМ от 16.07.2021, вход на массовые мероприятия по-прежнему только по QR-коду. Это безопасно! И, похоже, новая норма для фестивалей и концертов.
          </p>
        </div>
        <button
