<template>
  <section class="faq">
    <div class="container">
      ...
      <div class="faq-items">
        <div v-for="faq_item in faq_items" :key="faq_item.id">
          ...
          <div class="faq-item__inner" v-html="faq_item.answer"></div>
        </div>
...
export default {
  ...
  async asyncData({ $axios }) {
    const get_faq = await $axios.get(`/api/get_faq`);
    const faq_items = get_faq.data;
    return { faq_items };
  },
  data() {
    return {};
