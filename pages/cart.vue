  ...
  <section class="cart">
    ...
    <div class="container" v-if="data.cartitem_set && data.cartitem_set.length">
      ...
      <p class="cart__info">
        ...
        <b>Билет придет вам на email</b> после оплаты. Он не именной. При входе на фестиваль билет считывается и гасится, а вы получаете взамен браслет посетителя. Если 7 или 8 августа вы не погасили свой билет, то вы сможете пройти по нему на Стримфест 2022. Билет продолжит действовать, но станет невозвратным.<br /><br />
        ...
        фестиваль или 7, или 8 августа — на ваш выбор.<br /><br />
