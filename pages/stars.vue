  ...
  <section class="streamers">
    <div class="container">
      ...
      <div class="section-subheader">
        ...
        <p><b>ВНИМАНИЕ! Стримфест проходит в безопасном формате COVID-free.</b> Для входа нужны билет, QR-код и паспорт, подробности в <nuxt-link class="link" to="/faq">FAQ</nuxt-link>.</p>
      </div>
    </div>
