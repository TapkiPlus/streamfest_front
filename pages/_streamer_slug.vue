      ...
      <div class="streamer-container">
        ...
        <div v-if="streamer.sells" class="streamer-bottom">
          ...
          <p class="streamer-bottom__text">
            Покупая билет от участника, ты его поддерживаешь.<br>Часть стоимости билета идет участнику.<br><b>ВНИМАНИЕ! Стримфест проходит в безопасном формате COVID-free.</b> Для входа нужны билет, QR-код и паспорт, подробности в <nuxt-link class="link" to="/faq">FAQ</nuxt-link>.
          </p>
        </div>
      </div>
    </div>
